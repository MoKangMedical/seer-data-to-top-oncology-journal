...
1. **构建镜像**
```bash
docker build -t seer-data-to-top-oncology-journal .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name seer-data-to-top-oncology-journal seer-data-to-top-oncology-journal
```
...
- **问题反馈**: https://github.com/MoKangMedical/seer-data-to-top-oncology-journal/issues
